...
HD_PWD='D:/Fall 2018/CS151/CS151-Verilog-Project/CS151_Processor/CS151_Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CS151_Processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CS151_Processor.tcl
