...
HD_PWD='D:/Fall 2018/CS151/CS151-Verilog-Project/CS151-processor/CS151-processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log insDec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source insDec.tcl
